...
import { useApp, ADMIN_CREDS, createHoldings, createStaking } from "./AppContext";
import { C, S, btn, globalCSS } from "./theme";
import { TickerBar } from "./components";
  ...
  return (
    <nav style={S.nav}>
      ...
      <div style={S.row}>
        ...
        <button style={btn()} onClick={onRegister}>Get Started</button>
      </div>
    </nav>
  );
}
    ...
    <div style={S.app}>
      ...
      <div style={{ maxWidth: 1140, margin: "0 auto", padding: "56px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <p style={{ color: C.text3, fontSize: 17, maxWidth: 500, margin: "0 auto 32px", lineHeight: 1.7 }}>
        ...
        <div style={S.g3}>
          {[
            { icon: "🔐", t: "Bank-Grade Security", d: "Multi-sig wallets, cold storage, 2FA and insurance backed vaults." },
            { icon: "⚡", t: "Instant Settlements", d: "Sub-second trades with deep liquidity across 200+ trading pairs." },
            { icon: "📈", t: "Staking & Yield", d: "Earn up to 18% APY by staking your idle crypto assets." },
            { icon: "💸", t: "Ultra-Low Fees", d: "Industry-lowest trading fees starting at just 0.05% per trade." },
            { icon: "📊", t: "Advanced Analytics", d: "Real-time charts, portfolio tracking and profit/loss reports." },
            { icon: "🌍", t: "Global Transfers", d: "Send crypto anywhere in the world in seconds with minimal fees." },
          ].map((f, i) => (
            <div key={i} style={{ ...S.scard, transition: "border-color .2s" }}>
...
export function RegisterPage() {
  ...
  const doRegister = useCallback(() => {
    ...
    setView("login");
  }, [name, email, password, confirm, users, setUsers, showAlert, showToast, setView]);
