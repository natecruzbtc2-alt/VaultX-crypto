...
// ─── PRICE PROVIDER (completely isolated) ─────────────────────────────────────
...
export function AppProvider({ children }) {
  ...
  const value = {
    ...
    users,setUsers,txHistory,setTxHistory,pending,setPending,
    feeReqs,setFeeReqs,toast,setToast,modal,setModal,alert,setAlert,
    showToast,showAlert,updateUser,addTx,getTxs,removePending,doLogout,
  };
